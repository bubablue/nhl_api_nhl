...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { amount: @bet.amount, away: @bet.away, gamePk: @bet.gamePk, gameStatus: @bet.gameStatus, home: @bet.home, loose: @bet.loose, paid: @bet.paid, win: @bet.win } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { amount: @bet.amount, away: @bet.away, gamePk: @bet.gamePk, gameStatus: @bet.gameStatus, home: @bet.home, loose: @bet.loose, paid: @bet.paid, win: @bet.win } }
