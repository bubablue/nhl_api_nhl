...
class BetsTest < ApplicationSystemTestCase
  ...
  test "creating a Bet" do
    ...
    fill_in "Away", with: @bet.away
    fill_in "Gamepk", with: @bet.gamePk
    fill_in "Gamestatus", with: @bet.gameStatus
    fill_in "Home", with: @bet.home
    fill_in "Loose", with: @bet.loose
    fill_in "Paid", with: @bet.paid
    fill_in "Win", with: @bet.win
    click_on "Create Bet"
